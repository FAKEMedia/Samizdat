...
sub register ($self, $app, $conf) {
  ...
  $manager->get('invoices/:invoiceid')->to('Invoice#handle');
  $manager->get('invoices/:invoiceid/:to')->to('Invoice#nav');
  $manager->get('invoices/:invoiceid/creditinvoice')->to('Invoice#creditinvoice');
